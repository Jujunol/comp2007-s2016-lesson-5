    ...
    <div class="container">
        <div class="row">
            <div class="col-md-offset-2 col-md-8">
                ...
                <a href="DepartmentDetails.aspx" class="btn btn-sm btn-success"><i class="fa fa-plus"></i></a>
                ...
                <asp:GridView runat="server" ID="DepartmentGridView" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField HeaderText="Edit" Text="<i class='fa fa-pencil-square-o'></i>" ControlStyle-CssClass="btn btn-sm btn-success"
                            NavigateUrl="~/DepartmentDetails.aspx" DataNavigateUrlFields="DepartmentID" DataNavigateUrlFormatString="DepartmentDetails.aspx?DepartmentID={0}" />
